...
header.innerHTML=`
			<nav>
				<a href="Admin.html"><img src="../images/logoSantu.png" height="50px" width="130px"></a>
				<div class="admin">
					<p>Admin</p>
...
leftBar.innerHTML=`
				...
				<a href="RemoveCourse.html">&nbsp;&nbsp;Course Delete</a>
				<a href="#">&nbsp;&nbsp;Course Update</a>
				<a href="AccountBlock.html">&nbsp;&nbsp;Student Account block</a>
